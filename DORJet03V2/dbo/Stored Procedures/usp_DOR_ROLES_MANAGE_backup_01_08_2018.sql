create PROCEDURE [dbo].[usp_DOR_ROLES_MANAGE_backup_01_08_2018]          
(           
 @xml XML,          
...
BEGIN          
 ...
 --SET @vUserId = SCOPE_IDENTITY();        
  ...
  a.delete_fg , a.edit_locked_record_fg         
  ...
  WHEN NOT MATCHED BY TARGET THEN           
   INSERT (role_id, module_id, view_fg, insert_fg, update_fg, delete_fg,edit_locked_record_fg)           
   VALUES(src.role_id, src.module_id, src.view_fg, src.insert_fg, src.update_fg, src.delete_fg, src.edit_locked_record_fg)          
  WHEN MATCHED THEN           
