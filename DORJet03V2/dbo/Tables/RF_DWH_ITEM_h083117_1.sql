CREATE TABLE [dbo].[RF_DWH_ITEM_h083117] (
    ...
    CONSTRAINT [PK_RF_DWH_ITEM] PRIMARY KEY CLUSTERED ([item_id] ASC),
    CONSTRAINT [Item Name] UNIQUE NONCLUSTERED ([item_nm] ASC, [deleted_date] ASC),
    CONSTRAINT [Item No] UNIQUE NONCLUSTERED ([item_no] ASC, [deleted_date] ASC)
);
